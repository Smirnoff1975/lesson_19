...
> #Образ это дистрибутив контейнера, а контейнер это развернутый экземпляр образа.

Вывод опишите в домашнем задании.
- Ответьте на вопрос: Можно ли в контейнере собрать ядро?

> У контейнера нет собственного ядра, но собрать другое ядро в контейнере теоретически можно, передав дистрибутив ядра и забрав собранный образ через подключенные volumes,  но тестировать все равно придется вне контейнера.

Формат сдачи:
- Собранный образ необходимо запушить в docker hub и дать ссылку на ваш репозиторий.

> Итоговый образ загруженный на docker hub https://hub.docker.com/repository/docker/psmirnoff1975/nginx-custom/general
